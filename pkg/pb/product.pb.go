...
var file_pkg_pb_product_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x20,
	...
	0x72, 0x72, 0x6f, 0x72, 0x32, 0x9e, 0x01, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3c, 0x0a, 0x07, 0x46, 0x69, 0x6e, 0x64, 0x4f,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4e, 0x0a, 0x0d, 0x44, 0x65, 0x63, 0x72, 0x65, 0x61, 0x73,
...
var file_pkg_pb_product_proto_goTypes = []interface{}{
	(*FindOneData)(nil),           // 0: product.FindOneData
	(*FindOneRequest)(nil),        // 1: product.FindOneRequest
	(*FindOneResponse)(nil),       // 2: product.FindOneResponse
	(*DecreaseStockRequest)(nil),  // 3: product.DecreaseStockRequest
	(*DecreaseStockResponse)(nil), // 4: product.DecreaseStockResponse
}
var file_pkg_pb_product_proto_depIdxs = []int32{
	0, // 0: product.FindOneResponse.data:type_name -> product.FindOneData
	1, // 1: product.ProductService.FindOne:input_type -> product.FindOneRequest
	3, // 2: product.ProductService.DecreaseStock:input_type -> product.DecreaseStockRequest
	2, // 3: product.ProductService.FindOne:output_type -> product.FindOneResponse
	4, // 4: product.ProductService.DecreaseStock:output_type -> product.DecreaseStockResponse
